...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	if ((($_FILES["hor_src"]["type"] == "image/gif")
	|| ($_FILES["hor_src"]["type"] == "image/jpeg")
	|| ($_FILES["hor_src"]["type"] == "image/pjpeg")
	|| ($_FILES["hor_src"]["type"] == "image/png"))
	&& ($_FILES["hor_src"]["size"] < 11000000)) {
	  if ($_FILES["hor_src"]["error"] > 0)
	    {
	    echo "Return Code: " . $_FILES["hor_src"]["error"] . "<br />";
	...
	$arr = array(
		'hor_src' => '/u_file/develop/' . $pic_name,
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table">
	...
	<tr>
		...
		<td class="ck_editor"><textarea class="ckeditor" name="hor_commend"></textarea></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
